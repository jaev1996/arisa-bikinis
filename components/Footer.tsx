    ...
    <footer className="bg-primary text-secondary py-8 mt-10 w-full border-t border-accent/40">
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center justify-center">
          <Image src="/logos/arisa-alternative-bg-black.jpg" alt="Logo Alternativo Arisa" width={230} height={100} className="mx-auto mb-2" />
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="flex gap-4 mb-2">
            <a href="https://www.instagram.com/arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-accent hover:text-secondary transition">
            ...
            <a href="https://www.facebook.com/arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-accent hover:text-secondary transition">
            ...
            <a href="https://www.tiktok.com/@arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-accent hover:text-secondary transition">
