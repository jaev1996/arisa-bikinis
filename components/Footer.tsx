export default function Footer() {
  return (
    <footer className="bg-black text-white py-8 mt-10 w-full">
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-6">
        <div className="text-center sm:text-left text-sm">
          ...
          <p className="mb-1">Correo: <a href="mailto:contacto@arisabikinis.com" className="underline text-pink-400 hover:text-pink-300">contacto@arisabikinis.com</a></p>
          <p className="mb-1">Teléfono: <a href="tel:+584141234567" className="underline text-pink-400 hover:text-pink-300">+58 414 1234567</a></p>
          <p className="mt-2 text-neutral-400">Sitio desarrollado por <a href="https://www.eleva.marketing" target="_blank" rel="noopener noreferrer" className="underline text-pink-400 hover:text-pink-300">Eleva Marketing</a></p>
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="flex gap-4 mb-2">
            <a href="https://www.instagram.com/arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-400 transition">
            ...
            <a href="https://www.facebook.com/arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-pink-400 transition">
            ...
            <a href="https://www.tiktok.com/@arisabikinis" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-pink-400 transition">
